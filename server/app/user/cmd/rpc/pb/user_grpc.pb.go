...
func (c *userClient) UserFindByPhone(ctx context.Context, in *PhoneReq, opts ...grpc.CallOption) (*UserInfoReply, error) {
	out := new(UserInfoReply)
...
func _User_UserFindByPhone_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).UserFindByPhone(ctx, req.(*PhoneReq))
	}
	return interceptor(ctx, in, info, handler)
}
