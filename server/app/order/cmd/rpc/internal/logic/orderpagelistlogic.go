...
type OrderPageListLogic struct {
	ctx    context.Context
	svcCtx *svc.ServiceContext
	logx.Logger
}

func NewOrderPageListLogic(ctx context.Context, svcCtx *svc.ServiceContext) *OrderPageListLogic {
	return &OrderPageListLogic{
		ctx:    ctx,
		svcCtx: svcCtx,
...
func (l *OrderPageListLogic) OrderPageList(in *orderpb.OrderPageListReq) (*orderpb.OrderPageListReply, error) {

	orderList, total, err := l.svcCtx.OrderModel.OrderListPage(l.ctx, &request.PageListReq{
