...
func (s *ProductServer) ProductDeductionStock(ctx context.Context, in *pb.ProductDeductionStockReq) (*pb.ProductNil, error) {
	l := logic.NewProductDeductionStockLogic(ctx, s.svcCtx)
